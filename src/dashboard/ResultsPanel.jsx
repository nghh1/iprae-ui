              ...
              <Tabs defaultValue="normal" className="w-full">
                ...
                <TabsContent value="normal" className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-slate-50 p-4 rounded-lg border border-slate-200">
                      <p className="text-xs font-semibold text-slate-500 uppercase flex items-center">Sortino Ratio <InfoTooltip align="right" text="Risk-adjusted return focusing on downside volatility." /></p>
                ...
                <TabsContent value="stress" className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                      <p className="text-xs font-semibold text-red-700 uppercase flex items-center">
                        Stress Sortino <InfoTooltip align="right" text="Risk-adjusted return during a bear market drift." />
                      </p>
